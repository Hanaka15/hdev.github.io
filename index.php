...
<html>
   ...
   <body>
      <div class="container">
         <div class="card">
           <div class="section">
             <img class="card-logo" src="assets/img/logo.png">
           </div>
           ...
           <div class="section">
            ...
            <hr>
              <div class="section">
                    <ul>
                        <li>
                            <i class="material-icons">verified_user</i> <span>Stable and reliable system</span>
                        </li>
                        <li>
                            <i class="material-icons">touch_app</i> <span>Calculate time automaticly</span>
                        </li>
                        <li>
                            <i class="material-icons">storage</i> <span>Discord integration for easy access</span>
                        </li>
                    </ul>
                </div>
                  <hr>
